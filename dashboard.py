...
ap.add_argument("--thermo-tanque", nargs=3, type=int, default=[13, 15, 19],
                metavar=('SCK', 'CS', 'SO'), help="Pinos GPIO para sensor temperatura Tanque (padrão: 13 15 19)")
...
ap.add_argument("--tambor-dir-pin", type=int, default=15, help="Pino GPIO para DIR+ Driver Motor Tambor (padrão: 15)")
